...
sys.path.append("/Data1/csy/")
sys.path.append("/Data1/csy/ReBADD")
sys.path.append("/Data1/csy/ReBADD/JTVAE_BA")
sys.path.append("/Data1/csy/ReBADD/JTVAE_BA/jtnn")
sys.path.append("/Data1/csy/ReBADD/JTVAE_BA/BA_module")
...
while iteration < 5:
    ...
    next_inputs = sgp.batched_greedy_ei(60, np.min(X_train, 0), np.max(X_train, 0)) # 60
    valid_smiles = []
    new_features = []
    for i in range(60):
    ...
    for i in range(len(valid_smiles)):
        ...
        print('MolFromSmiles(valid_smiles[ i ]) : ',  MolFromSmiles(valid_smiles[ i ]))
        ba_bcl2  = scorer_bcl2(MolFromSmiles(valid_smiles[ i ]))
        ba_bclxl = scorer_bclxl(MolFromSmiles(valid_smiles[ i ]))
        ba_bclw  = scorer_bclw(MolFromSmiles(valid_smiles[ i ]))
        print(ba_bcl2)
